<?php  //[STAMP] 1482c85881ba3362c11e2635acbaa812
// phpcs:ignoreFile
...
trait AcceptanceTesterActions
{
     ...
     * @see \Tests\Support\Helper\Acceptance::myFill()
     */
    public function myFill(string $labelOrPlaceholder, string $value, \Tests\Support\Enums\FieldTypes $type): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('myFill', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Tests\Support\Helper\Acceptance::myFill()
     */
    public function tryToMyFill(string $labelOrPlaceholder, string $value, \Tests\Support\Enums\FieldTypes $type): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('myFill', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes myFill and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\Acceptance::myFill()
     */
    public function retryMyFill(string $labelOrPlaceholder, string $value, \Tests\Support\Enums\FieldTypes $type) {
        $retryNum      = $this->retryNum ?? 1;
        $retryInterval = $this->retryInterval ?? 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('myFill', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * @see \Tests\Support\Helper\Acceptance::myClick()
     */
    public function myClick(string $value, int $index = 1): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('myClick', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Tests\Support\Helper\Acceptance::myClick()
     */
    public function tryToMyClick(string $value, int $index = 1): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('myClick', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes myClick and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\Acceptance::myClick()
     */
    public function retryMyClick(string $value, int $index = 1) {
        $retryNum      = $this->retryNum ?? 1;
        $retryInterval = $this->retryInterval ?? 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('myClick', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     *
     *
     * @see \Tests\Support\Helper\Acceptance::myGetValue()
     */
    public function myGetValue(string $text, \Tests\Support\Enums\FieldTypes $type): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('myGetValue', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Tests\Support\Helper\Acceptance::myGetValue()
     */
    public function tryToMyGetValue(string $text, \Tests\Support\Enums\FieldTypes $type): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('myGetValue', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes myGetValue and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\Acceptance::myGetValue()
     */
    public function retryMyGetValue(string $text, \Tests\Support\Enums\FieldTypes $type) {
        $retryNum      = $this->retryNum ?? 1;
        $retryInterval = $this->retryInterval ?? 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('myGetValue', func_get_args(), $retryNum, $retryInterval));
    }
}
